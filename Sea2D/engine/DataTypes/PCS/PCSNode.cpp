...
//        //strncpy(this->name, inName, PCSNODE_NAME_SIZE);
//        // Null terminator
...
//    PCSError PCSNode::setName(const char * const inName)
//    {
//        // Check for invalid parameter
//        if (inName == nullptr)
//        {
//            return PCSError::FailPointerWasNull;
//        }
//        
...
//        }
//        
//        return PCSError::Success;
//    }
//    
//    
//    PCSError PCSNode::getName(char * const outBuffer, unsigned int sizeOutBuffer) const
//    {
//        // Check for invalid parameter
